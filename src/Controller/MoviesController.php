...
class MoviesController extends AbstractController
{
    ...
    private $validator;
    public function __construct(EntityManagerInterface $em, MovieRepository $movieRepository, ValidatorInterface $validator)
    {
        $this->em = $em;
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($imagePath) {
                ...
                if ($imagePath->isValid()) {
                    ...
                    $errors = $this->validator->validate($imagePath);
    ...
    public function edit($id, Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($imagePath) {
                ...
                $movie->setRealeseYear($form->get('realeseYear')->getData());
